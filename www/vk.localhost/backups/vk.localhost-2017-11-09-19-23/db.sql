...
INSERT INTO `cms_activity` VALUES (70,8,2,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-09-24 07:55:13',0,NULL,1),(71,8,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2017-10-02 15:49:05',0,NULL,1),(72,10,3,2,'Группа пользователей сайта',2,'groups/2',NULL,NULL,NULL,'2017-10-29 06:52:43',0,NULL,1);
...
CREATE TABLE `cms_groups` (
  ...
  KEY `slug` (`slug`),
  FULLTEXT KEY `title` (`title`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Группы (сообщества)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_groups` VALUES (2,2,'2017-10-29 06:50:01','Группа пользователей сайта','<p>\r\n	В этой группе вы можете обратиться к администрации сайта, высказать свои замечания, пожелания, предложения, претензии. Или просто выразить своё мнение по любому вопросу. А мы будем сообщать здесь о новостях и изменениях в работе сайта.\r\n</p>',NULL,0,2,0,0,0,0,0,NULL,NULL,'---\nposts: 0\nalbums: 0\n','---\nposts: null\nalbums: null\n','---\n','---\nposts: null\nalbums: null\n');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Члены групп (сообществ)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cms_groups_members` VALUES (1,2,2,2,'2017-10-29 06:50:01'),(2,2,3,1,'2017-10-29 06:52:43');
...
INSERT INTO `cms_scheduler_tasks` VALUES (1,'Перевод пользователей между группами','users','migration',1440,'2017-11-09 14:40:06',1,0),(2,'Создание карты сайта','sitemap','generate',1440,'2017-11-09 14:40:08',1,0),(3,'Выдача приглашений пользователям','auth','send_invites',1440,'2017-11-09 14:40:09',1,0),(4,'Публикация контента по расписанию','content','publication',1440,'2017-11-09 14:40:09',1,0),(5,'Очистка удалённых личных сообщений','messages','clean',1440,'2017-11-09 14:40:10',1,0),(6,'Удаление пользователей, не прошедших верификацию','auth','delete_expired_unverified',60,'2017-11-09 16:00:02',1,0),(7,'Удаление просроченных записей из корзины','moderation','trash',30,'2017-11-09 16:15:13',1,0);
...
INSERT INTO `cms_sessions_online` VALUES ('8o23jm1tot687mknrdnm0b8545',2,'2017-11-09 16:21:32'),(NULL,2,'2017-11-09 16:23:01');
...
INSERT INTO `cms_users` VALUES (1,'---\n- 6\n','admin@regvo.ru','7a2a1a3779d170f39fde296c551fd40a','02480f1963292bd8',1,'nizkovsky','2017-09-24 07:10:24','2017-09-24 07:55:22','2017-09-24 07:10:24','127.0.0.1',NULL,NULL,NULL,NULL,NULL,'2017-09-24 08:05:42',0,0,'Europe/Moscow',5000,10000,'---\nbg_img: null\nbg_color: \'#ffffff\'\nbg_repeat: no-repeat\nbg_pos_x: left\nbg_pos_y: top\nmargin_top: 0\n','---\nusers_friend_add: both\nusers_friend_delete: both\ncomments_new: both\ncomments_reply: email\nusers_friend_aссept: pm\ngroups_invite: email\nusers_wall_write: email\n','---\nusers_profile_view: anyone\nmessages_pm: anyone\n',NULL,NULL,NULL,0,'2017-09-24 08:05:42','1974-05-01 00:00:00',15789553,'Красавино',NULL,'---\nnormal: 000/u2/cb/76/e9a66712.jpg\nsmall: 000/u2/b8/cd/d28f9ec6.jpg\nmicro: 000/u2/c4/dc/44066336.jpg\n',NULL,NULL,NULL,NULL,NULL),(2,'---\n- 6\n','administrator@regvo.ru','62d936edfa8c91e951c245628cc38768','1e17624282235180',1,'Администратор','2017-09-24 07:55:13','2017-11-09 16:23:01','2017-09-24 07:55:13','::1',NULL,NULL,NULL,NULL,NULL,NULL,0,0,'Europe/Moscow',1000,5000,NULL,'---\ncomments_new: email\ncomments_reply: email\ngroups_invite: both\nmessages_new: email\nusers_friend_add: email\nusers_friend_accept: pm\nusers_friend_delete: email\nusers_wall_write: email\n',NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'---\n- 4\n','senn@bk.ru','a0dd133d4ca70d320c5ef2072ce9243a','bc95b28156875856',NULL,'snn','2017-10-02 15:49:04','2017-10-29 11:20:38','2017-10-02 15:49:04','::1',NULL,NULL,NULL,NULL,NULL,NULL,0,0,'Europe/Moscow',0,0,NULL,'---\ncomments_new: email\ncomments_reply: email\ngroups_invite: both\nmessages_new: email\nusers_friend_add: email\nusers_friend_accept: pm\nusers_friend_delete: email\nusers_wall_write: email\n',NULL,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `cms_users_auth_tokens` VALUES (1,'497e167befabca570d1257746b05ef00','2017-09-24 07:56:05','2017-11-09 16:23:01',2,'---\ntype: desktop\nsubj: null\n',2130706433),(2,'9506134b90f55b9c44698197ac344a69','2017-10-24 13:42:01','2017-10-29 11:20:38',3,'---\ntype: desktop\nsubj: null\n',0);
...
-- Dump completed on 2017-11-09 19:23:17
